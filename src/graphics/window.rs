...
pub const WINDOW_INNER_SIZE: Size = Size::Physical(PhysicalSize {
    width: WINDOW_WIDTH,
...
pub fn create_surface(
    ...
    let centered_pos: Position =
        Position::Physical(PhysicalPosition::new(centered_w as i32, centered_h as i32));
